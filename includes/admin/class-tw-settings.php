...
/**
 * Main Tweet Wheel Admin Settigns Class
 *
 * @since 0.0.1
 */
...
if( ! class_exists( 'TW_Settings' ) ) :
    
/**
* TW_Settings class; settings framework
*/
...
class TW_Settings {
    ...
    public function __construct() {
        ...
        include_once( 'settings/class-tw-settings-home.php' );
        include_once( 'settings/class-tw-settings-auth.php' );
        include_once( 'settings/class-tw-settings-general.php' );
     ...
     */
    public function set_setting( $settings_file, $option_group = '' )
    {
