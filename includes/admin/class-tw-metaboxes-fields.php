...
abstract class CMB_Field {
	...
	public function display() {
		...
		foreach ( $values as $key => $value ) {
            ...
            do_action( 'tw_before_metabox_field_' . $this->id, $this );
...
add_filter( 'cmb_field_types', function( $cmb_field_types ) {
    $cmb_field_types['hidden'] = 'CMB_Hidden_Field';
 ...
 *
 */
class CMB_Custom_Field extends CMB_Field {
...
add_filter( 'cmb_field_types', function( $cmb_field_types ) {
    $cmb_field_types['custom'] = 'CMB_Custom_Field';
    return $cmb_field_types;
} );
